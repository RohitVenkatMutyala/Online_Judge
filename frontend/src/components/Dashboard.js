...
// FIX 1: Import setDoc instead of updateDoc
...
function Dashboard() {
  ...
  return (
    <>
                    ...
                    <div className="navigation-grid">
                      <div className="nav-card mb-4" onClick={() => navigate("/new-chat")}>
                        <div className="nav-card-inner d-flex align-items-center p-4 rounded-3 shadow-sm h-100">
                          <div className="nav-icon me-4"><i className="bi bi-broadcast-pin"></i></div>
                      ...
                      <div className="nav-card mb-4" onClick={() => navigate("/problems")}>
                        <div className="nav-card-inner d-flex align-items-center p-4 rounded-3 shadow-sm h-100">
                          <div className="nav-icon me-4"><i className="bi bi-puzzle-fill"></i></div>
                          <div className="nav-content flex-grow-1">
                      ...
                      <div className="nav-card mb-4" onClick={() => navigate("/funda")}>
                        <div className="nav-card-inner d-flex align-items-center p-4 rounded-3 shadow-sm h-100">
                          <div className="nav-icon me-4"><i className="bi bi-book-half"></i></div>
                          <div className="nav-content flex-grow-1">
                      ...
                      <div className="nav-card mb-4" onClick={() => navigate("/contexts")}>
                        <div className="nav-card-inner d-flex align-items-center p-4 rounded-3 shadow-sm h-100">
                          <div className="nav-icon me-4"><i className="bi bi-collection-fill"></i></div>
                          <div className="nav-content flex-grow-1">
                      ...
                      <div className="nav-card" onClick={() => navigate("/sub")}>
                        <div className="nav-card-inner d-flex align-items-center p-4 rounded-3 shadow-sm h-100">
                          <div className="nav-icon me-4"><i className="bi bi-check2-square"></i></div>
                          <div className="nav-content flex-grow-1">
      ...
      <style>{`
        .dashboard-container { min-height: 600px; }
        ...
        .nav-card-inner { background: "linear-gradient(135deg, #a8edea 0%, #dcedc2 100%)"; color: white; transition: all 0.3s ease; border: none; min-height: 100px; }
        .nav-card:hover .nav-card-inner { background: linear-gradient(135deg, #f12711 0%, #f5af19 100%); box-shadow: 0 8px 25px rgba(241, 39, 17, 0.3) !important; }
        .nav-icon { width: 60px; height: 60px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; }
        .nav-arrow { font-size: 1.5rem; opacity: 0.7; transition: all 0.3s ease; }
        .nav-card:hover .nav-arrow { opacity: 1; transform: translateX(5px); }
