    ...
    function handleEditorDidMount(editor, monaco) {
        ...
        editor.addAction({
            ...
            run: function (ed) {
                ...
                handleAIDebug(selectedText || ed.getValue());
            },
        });
    }
                ...
                <div className="row g-4">
                                    ...
                                    <div className="row align-items-center">
                                        <div className="col-md-6 mb-3 mb-md-0">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <span className={getDifficultyBadge(problem.difficulty)}>{problem.difficulty?.toUpperCase() || 'UNKNOWN'}</span>
                                            </div>
                                        </div>
                                                ...
                                                <div className="d-flex align-items-center flex-wrap">
                                                    ...
                                                    <div className="d-flex flex-wrap">
                                                        {problem.tag.split(',').map((tag, idx) => (
                                                            <span key={idx} className={`${getTagBadge(tag.trim())} tag-badge`}>{tag.trim()}</span>
                                                        ))}
                                                    </div>
                                                </div>
                                            )}
                                        ...
                                        <div className="col-md-6 mb-3 mb-md-0">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <span className="badge bg-info-subtle border border-info-subtle text-info-emphasis rounded-pill px-3">{problem.QID}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className={`tab-content border border-top-0 p-3 rounded-bottom bg-${theme === 'dark' ? 'dark' : 'light'} text-${theme === 'dark' ? 'light' : 'dark'}`} style={{ minHeight: '180px' }}>
                            ...
                            {activeTab === 'output' && (
                                <div className="tab-pane fade show active">
                                    {output ? (<pre className="mb-0">{output}</pre>) : (<p className="text-muted">Run code to see output.</p>)}
                                </div>
                            )}
                            {activeTab === 'verdict' && (
                                <div className="tab-pane fade show active">
