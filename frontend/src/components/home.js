        ...
        <section className="container py-5">
          <div className="feature-tree">
            ...
            <FeatureCard
              ...
              description="Transform your resume with AI-powered analysis, ATS compatibility scoring, and smart improvement suggestions. Get real-time feedback, save most recent versions, and export a professional LaTeX resume that beats applicant tracking systems."
            />
